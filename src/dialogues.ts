...
export const dialogues: DialogueInterface[] = [
    {
        id: "NPC_1",
        npcName: "Aria",
        message: "Bonjour, je suis Thomas, conducteur de travaux. Je vous propose de répondre à 4 questions pour découvrir les valeurs que nous partageons chez Eiffage Énergie Système.",
    ...
    },
    {
        id: "NPC_8",
        npcName: "Aria",
        message: " Salut, moi c'est Thibaut, je suis technicien de maintenance CVC. Découvrez en vidéo mon métier chez chez Eiffage Énergie Systèmes.",
